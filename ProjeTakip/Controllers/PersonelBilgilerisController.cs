...
namespace ProjeTakip.Controllers
{
    public class PersonelBilgilerisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonelBilgileriId,Eposta,Sifre,Yetki,AdSoyad,PersonelGörseli,TCNO,Departman,Gorev,PozisyonAciklama,TelNo,Adres,MedeniHal,YakinBilgisi,YakinTC,YakinAdSoyad,YakinTel,DogumTarihi,IseGirisTarihi")] PersonelBilgileri personelBilgileri)
        {
